========================================================================
    APLICACIÓN: Grafo_grafico Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Grafo_grafico.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Grafo_grafico.

Grafo_grafico.vcxproj
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Grafo_grafico.pch y un archivo de tipos precompilados llamado StdAfx.obj.
